...
(function (e, t) {
    ...
    r = x(a),
        function (e, t) {
            ...
            function kt(e) {
                ...
                for (; i > l; l++) if (n = o.relative[e[l].type]) f = [
                    wt(Tt(f), n)
                ];
                else {
    ...
    function Ft(e, n) {
        ...
        if (!s) for (s = [
        ], r = e.childNodes || e; null != (o = r[a]); a++) !n || x.nodeName(o, n) ? s.push(o)  : x.merge(s, Ft(o, n));
...
x.each({
    ...
    'object' == typeof module && module && 'object' == typeof module.exports ? module.exports = x : (e.jQuery = e.$ = x, 'function' == typeof define && define('jquery/jquery/1.10.1/jquery', [
    ], function () {
        return x
    }))
}) (window);
