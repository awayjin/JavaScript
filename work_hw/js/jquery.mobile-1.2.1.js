			...
			this.element
				.css({
					top: $.support.scrollTop && $window.scrollTop() + $window.height() / 2 ||
						activeBtn.length && activeBtn.offset().top || 0
				});
		},
...
(function( $, undefined ) {
	...
	var $window = $( window ),
		...
		urlHistory = {
			...
			directHashChange: function( opts ) {
                ...
                console.log("##############$.mobile.directHashChange.opts=");
	...
	function resetActivePageHeight() {
        ...
        aPage.css( "height", getScreenHeight() - aPagePadT - aPagePadB - aPageBorderT - aPageBorderB );
	}
		...
		if ( !( $.mobile.allowCrossDomainPages || path.isSameDomain( documentUrl, absUrl ) ) ) {
			...
			$.ajax({
				...
				success: function( html, textStatus, xhr ) {
					...
					// correct url. 4 into a temprorary element makes these requests immediately
	...
	$.mobile.changePage = function( toPage, options ) {
         ...
         console.log(JSON.stringify($.mobile.urlHistory.stack));
...
/*        console.log("##############$.mobile.loadpage.toPage typeof= "+typeof(toPage));
        console.log("##############$.mobile.loadpage.toPage=");
        console.log(JSON.stringify(toPage));

        console.log("##############$.mobile.loadpage.settings typeof= "+typeof(settings));
        console.log(JSON.stringify(settings));*/

        /*console.log("##############$.mobile.loadpage.triggerData typeof= "+typeof(triggerData));
		...
		if ( toPage.length>0 && toPage[ 0 ] === $.mobile.firstPage[ 0 ] && !settings.dataUrl ) {
