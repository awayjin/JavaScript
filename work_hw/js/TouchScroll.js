...
/*´´½¨½Úµã£¬Ö§³Ö´´½¨Ê±¸³ÓèÊôÐÔ£¨styleÌØÊâ´¦Àí£©
*@param string tag: ½ÚµãÀàÐÍ
*@param Object attr: ÊôÐÔÅäÖÃ
*/
$C:function(tag,attr){
...
*@param string css: Èç¹ûµÚ¶þ¸ö²ÎÊýcssÊÇ×Ö·û´®£¬¼´ÎªÑùÊ½µÄ¹Ø¼ü×Ö£¬Ôò·µ»Ø¶ÔÓ¦µÄÑùÊ½Öµ
*/
css:(function(){
...
var related,
type=e.type.toLowerCase();//ÕâÀï»ñÈ¡ÊÂ¼þÃû×Ö
if(type=='mouseover'){
...
this.refresh(0); this.refresh(1);/*Ë¢ÐÂºáÏòºÍ×ÝÏò¹ö¶¯Ìõ*/
...
*@param Number during: ¶¯»­³ÖÐøÊ±¼ä
*@param String fx: »º¶¯Ð§¹ûÃû³Æ
...
_fx=fx||'ease-out';//»º¶¯Ð§¹û
function animate(t,b,c,d,fx){ //»º¶¯Ð§¹û¼ÆËã¹«Ê½
var re;
switch(fx){
case 'ease-in-out':
...
start:function(e){
clearTimeout(this.timer[0]); clearTimeout(this.timer[1]);//Çå³ýÕýÔÚ½øÐÐµÄ¶¯»­
...
if(this.target){//Èç¹ûÍÏ¶¯µÄÊÇ¹ö¶¯Ìõ£¬ÐèÒª´¦ÀíÏÂ
...
var distance,//³¬³ö±ßÔµÐèÒªÐÞÕýµÄ³¤¶È
offset,//µ±Ç°Æ«ÒÆÖµ
now,//µ±Ç°Ê±¼ä
rect,//ÒÆ¶¯¾àÀëºá×ÝÊý¾Ý
dist,//Êµ¼ÊÒÆ¶¯¾àÀë
...
//¼ÆËã³ö×î½ü²»³¬¹ý200ºÀÃëÄÚÊý¾Ý£¬Ä¿µÄÊÇµÃ³ö×î½üÒ»´Î¿ìËÙÒÆ¶¯Ëù»¨·ÑµÄÊ±¼äºÍÒÆ¶¯¾àÀë£¬´Ó¶ø¼ÆËã³ö»º¶¯¾àÀë³¤¶È
now=new Date();
...
distance=(2-time/200)*dist; //¼ÆËã³ö»º¶¯ÐèÒªÒÆ¶¯µÄ¾àÀë
}
}
}
