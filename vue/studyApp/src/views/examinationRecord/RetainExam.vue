<template>
    <div class="bigBox"> <!--  保级考试 -->
        ...
        <div class="box">
            <div class="boxHeader ub ub-ac ub-ver">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div v-else>
                            <div v-show="obj.continuityCount==0 || obj.continuityCount%3 != 0" class="notice"><span>恭喜您，本次保级考试合格！</span></div>
            ...
            <div class="time">
                <div>
                    <h5>{{"这是您第"+obj.examCount+"次保级考试"}}</h5>
                </div>

                <div class="timer">
                   <div>
                       <p class="p" v-if="obj.examStartTime">
...
import requestMethods from "@/api/request";//请求路径引入
